...
export type FetchCommitHistoryQuery = { __typename?: 'Query', fetchCommitHistory: Array<{ __typename?: 'Commit', hash: string, name: string, description?: string | null, date: string }> };
...
export type FetchCommitDetailsQuery = { __typename?: 'Query', commits: Array<{ __typename?: 'Commit', hash: string, name: string, description?: string | null, date: string }> };
...
export type FetchSymbolsQuery = { __typename?: 'Query', symbolsAggregate: { __typename?: 'SymbolAggregateSelection', count: number }, fetchSymbols: Array<{ __typename?: 'SymbolFetchResult', name: string, address: string }> };
...
export type ListWinStructQuery = { __typename?: 'Query', winStructsAggregate: { __typename?: 'WinStructAggregateSelection', count: number }, winStructs: Array<{ __typename?: 'WinStruct', kind: string, size: number, fields: Array<{ __typename?: 'WinStructField', offset: number }> }> };
...
export type SearchFsQuery = { __typename?: 'Query', search: Array<{ __typename?: 'SearchResult', commit_name: string, commit_hash: string, path: string }> };
...
export type DiffNodesQuery = { __typename?: 'Query', diffNodesAt: Array<{ __typename?: 'DiffItem', status: DiffStatus, type: NodeType, path: string, new_props?: { __typename?: 'HashableNodeProps', hash: string, properties: any } | null, old_props?: { __typename?: 'HashableNodeProps', hash: string, properties: any } | null }> };
 ...
 * });
 */
export function useFetchSymbolsQuery(variables: FetchSymbolsQueryVariables | VueCompositionApi.Ref<FetchSymbolsQueryVariables> | ReactiveFunction<FetchSymbolsQueryVariables>, options: VueApolloComposable.UseQueryOptions<FetchSymbolsQuery, FetchSymbolsQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<FetchSymbolsQuery, FetchSymbolsQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<FetchSymbolsQuery, FetchSymbolsQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<FetchSymbolsQuery, FetchSymbolsQueryVariables>(FetchSymbolsDocument, variables, options);
}
export function useFetchSymbolsLazyQuery(variables?: FetchSymbolsQueryVariables | VueCompositionApi.Ref<FetchSymbolsQueryVariables> | ReactiveFunction<FetchSymbolsQueryVariables>, options: VueApolloComposable.UseQueryOptions<FetchSymbolsQuery, FetchSymbolsQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<FetchSymbolsQuery, FetchSymbolsQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<FetchSymbolsQuery, FetchSymbolsQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<FetchSymbolsQuery, FetchSymbolsQueryVariables>(FetchSymbolsDocument, variables, options);
}
export type FetchSymbolsQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<FetchSymbolsQuery, FetchSymbolsQueryVariables>;
 ...
 * });
 */
export function useListWinStructQuery(variables: ListWinStructQueryVariables | VueCompositionApi.Ref<ListWinStructQueryVariables> | ReactiveFunction<ListWinStructQueryVariables> = {}, options: VueApolloComposable.UseQueryOptions<ListWinStructQuery, ListWinStructQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ListWinStructQuery, ListWinStructQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ListWinStructQuery, ListWinStructQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<ListWinStructQuery, ListWinStructQueryVariables>(ListWinStructDocument, variables, options);
}
export function useListWinStructLazyQuery(variables: ListWinStructQueryVariables | VueCompositionApi.Ref<ListWinStructQueryVariables> | ReactiveFunction<ListWinStructQueryVariables> = {}, options: VueApolloComposable.UseQueryOptions<ListWinStructQuery, ListWinStructQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ListWinStructQuery, ListWinStructQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ListWinStructQuery, ListWinStructQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<ListWinStructQuery, ListWinStructQueryVariables>(ListWinStructDocument, variables, options);
}
export type ListWinStructQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<ListWinStructQuery, ListWinStructQueryVariables>;
