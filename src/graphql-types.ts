...
export type FetchStructsQuery = { __typename?: 'Query', winStructsAggregate: { __typename?: 'WinStructAggregateSelection', count: number }, fetchStructs: Array<{ __typename?: 'WinStructFetchResult', name: string, size: number, kind: string, fields: Array<{ __typename?: 'WinStructFieldFetchResult', name: string, offset: number, data_type: any }> }> };
