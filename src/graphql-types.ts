...
export type SearchFsQuery = { __typename?: 'Query', search: Array<{ __typename?: 'SearchResult', commit_name: string, commit_hash: string, hash: string, path: string }> };
...
export type SearchFsStreamSubscription = { __typename?: 'Subscription', searchStream: { __typename?: 'SearchResult', commit_name: string, commit_hash: string, hash: string, path: string } };
