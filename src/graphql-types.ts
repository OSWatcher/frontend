...
export type FetchStructsQuery = { __typename?: 'Query', structsAggregate: { __typename?: 'StructAggregateSelection', count: number }, fetchStructs: Array<{ __typename?: 'StructFetchResult', name: string, size: number, kind: string, fields: Array<{ __typename?: 'StructFieldFetchResult', name: string, offset: number, data_type: any }> }> };
...
export type SearchFsQuery = { __typename?: 'Query', search: Array<{ __typename?: 'SearchResult', type: SearchEntityType, commit_name: string, commit_hash: string, blob_path: string, blob_hash: string, entity_path?: string | null, node_hash: string }> };
...
export type SearchFsStreamSubscription = { __typename?: 'Subscription', searchStream: { __typename?: 'SearchResult', type: SearchEntityType, commit_name: string, commit_hash: string, blob_path: string, blob_hash: string, entity_path?: string | null, node_hash: string } };
